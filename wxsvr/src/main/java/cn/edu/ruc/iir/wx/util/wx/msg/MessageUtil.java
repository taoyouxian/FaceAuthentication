package cn.edu.ruc.iir.wx.util.wx.msg;

import cn.edu.ruc.iir.wx.domain.msg.resp.*;
 ...
 * @Description: 消息工具类 (被动回复消息转换成XML格式)
 * @date 2015年12月4日 上午10:25:28
 */
public class MessageUtil {
    ...
    /**
     * 事件推送：location_select(弹出地理位置选择器的事件推送)
     */
